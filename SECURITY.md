...
Once the project cuts its first release, a PGP key for encrypted reports will be published here and cross-signed into the repository. Until then, if your report needs encryption, send a short plaintext email requesting a secure channel; we will agree one before you send the details.
