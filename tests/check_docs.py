...
DOCNAME = r'(?:STATE-AND-RECOVERY|SYSTEM-VOLUMES|PACKAGE-FORMAT|ORCHARD-POLICY|HOMEBREW-REVIEW|BUILD-INFRA|KEY-RUNBOOK|NOMENCLATURE|REPOSITORIES|SLICE-FORMAT|CONTRIBUTING|AUTHORING|TOOLCHAIN|GENESIS|MANUAL|DESIGN|SETUP|SECURITY|HELPERS|REVIEW)(?:\.md)?'
