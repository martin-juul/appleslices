...
*History: v0.24 (September 2026) — resolve comparison-table conflicts for compatibility versus artifact identity and protected system-patch execution/recovery using STATE-AND-RECOVERY and SYSTEM-VOLUMES.*
