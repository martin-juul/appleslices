...
- **Companion to:** [DESIGN.md](DESIGN.md) v1.19 (§4.3 toolchain, §5.1 process layout, §9 distribution, §10 security), [PACKAGE-FORMAT.md](PACKAGE-FORMAT.md) v0.15 (build phases §6), [HOMEBREW-REVIEW.md](HOMEBREW-REVIEW.md) v0.21 (§4.7 merge gates, §6 risks)
