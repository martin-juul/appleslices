...
**signing host** — the restricted signing VM on the owned 2013 Mac Pro; verifies and signs results, never runs package builds. Build guests have no signing credentials or token access. Compromise of the shared physical host can defeat VM isolation. *(BUILD-INFRA §5, §7.)*
