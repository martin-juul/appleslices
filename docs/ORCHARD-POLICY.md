...
6. **Post-merge signing** — slice signing and the index snapshot update happen only after merge, on the signing host. No PR, however trusted, touches keys.
