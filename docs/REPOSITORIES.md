...
- **Companion to:** [DESIGN.md](DESIGN.md) v1.20 (§8 store/state, §9.6 repository system, §10.2 signatures, §12.5 logging, §12.6 doctor, §12.7 system software, §12.8 services, §12.10 trust store, §12.11 system patches, §12.12 self-update, §12.15 grafts), [PACKAGE-FORMAT.md](PACKAGE-FORMAT.md) v0.15, [BUILD-INFRA.md](BUILD-INFRA.md) v0.14 (§9 result→repository), [ORCHARD-POLICY.md](ORCHARD-POLICY.md) v1.8
