...
|---|---|---|---|---|---|---|---|
| `official` | Compiled-in fingerprint pin; only core/extended ship this way | Yes | n/a (it *is* the namespace) | Yes | Yes | Yes — farm-rehearsed, project-signed manifests (DESIGN §12.15) | Ed25519, threshold TUF root (DESIGN §10.2) |
