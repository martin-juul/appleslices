...
- Source version/date: master snapshot retrieved 2026-09-26; version is retained in the source
...
- Used by: REPOSITORIES, KEY-RUNBOOK, STATE-AND-RECOVERY §7–§8; TUF schemas
