...
- Used by:
  ...
  - [KEY-RUNBOOK §3.1 Planned root update or rotation](../KEY-RUNBOOK.md#31-planned-root-update-or-rotation): Root updates require sequential versions and old/new threshold authorization.
